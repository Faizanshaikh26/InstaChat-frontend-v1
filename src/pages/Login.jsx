  ...
  return (
    <div className=""
        ...
        >
          {isLogin ? (
            <>
   <div className={"bg-[url(https://img.freepik.com/premium-vector/seamless-pattern-with-different-social-media-icons_405287-75.jpg?size=626&ext=jpg&ga=GA1.1.2008272138.1721260800&semt=ais_user)]"}>
      ...
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form className="space-y-4 md:space-y-6" onSubmit={handleLogin}>
            ...
            <div className=" bg-no-repeat bg-cover bg-[url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRT-ic5YuREuRVOWH3QUkFVqrIcUL6l3QMuamK9iqtSJ2ahLmVEDCZipNnKGaSMfgpZ3Q&usqp=CAU)] " >
